    ...
    <Stack spacing={{ xs: 3, sm: 6 }} useFlexGap>
      <FormControl component="fieldset" fullWidth>
        ...
        >
          ...
          <Card
            raised={paymentType === 'cod'}
            sx={{
              maxWidth: { sm: '100%', md: '50%' },
              flexGrow: 1,
              outline: '1px solid',
              outlineColor:
                paymentType === 'cod' ? 'primary.main' : 'divider',
              backgroundColor:
                paymentType === 'cod' ? 'background.default' : '',
            }}
          >
            <CardActionArea onClick={() => setPaymentType('cod')}>
              <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <GiCash color="#4287f5" fontSize="small" />
                <Typography fontWeight="medium">COD</Typography>
              </CardContent>
            </CardActionArea>
          </Card>
          <Card
             raised={paymentType === 'razorpay'}
             sx={{
               maxWidth: { sm: '100%', md: '50%' },
               flexGrow: 1,
               outline: '1px solid',
               outlineColor:
                 paymentType === 'razorpay' ? 'primary.main' : 'divider',
               backgroundColor:
                 paymentType === 'razorpay' ? 'background.default' : '',
             }}
          >
            <CardActionArea onClick={() => setPaymentType('razorpay')}>
              <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <SiRazorpay color="#4287f5" fontSize="small"/>
                <Typography fontWeight="medium">Razorpay</Typography>
              </CardContent>
            </CardActionArea>
          </Card>
        </RadioGroup>
